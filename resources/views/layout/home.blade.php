            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="widget footer-about-us">
                  <img src="/front/img/logo_dark2 - .png" alt="" class="logo">
                  <p class="mb-30">Mayoutfit, Kemudahan Bagimu Adalah Prioritas Kami.</p>
              ...
              <div class="col-md-2 col-md-offset-1 col-sm-6 col-xs-12">
                <div class="widget footer-links">
                  <h5 class="widget-title bottom-line left-align grey"></h5>
              ...
              <div class="col-md-2 col-sm-6 col-xs-12">
                <div class="widget footer-links">
                  <h5 class="widget-title bottom-line left-align grey">Useful link</h5>
                  <ul class="list-no-dividers">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; 2024 Project Ecommerce - laravel by Nurul asanah</a>
                </span>
              </div>
